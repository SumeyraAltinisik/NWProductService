...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Products02122022> Products02122022s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=Northwind;User Id=sa; Password=Fbu2016-;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Products02122022>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Products_02122022");
        ...
        modelBuilder.Entity<UrunFiyatGecmisi>(entity =>
        {
            ...
            entity.Property(e => e.EskiFiyat).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.ProductsId).HasColumnName("ProductsID");
            entity.Property(e => e.YeniFiyat).HasColumnType("decimal(18, 2)");
        });
